...
### Commentaires pour les programmateurs{#comment} [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#questionstructure){#s8-1-2}
...
### Types de questions [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#questiontypes){#type_questions}
...
* [textline](#textline) Le participant peut saisir seulement une ligne de texte
...
* [youtube](#youtube) Montrer une vidéo YouTube

Il existe différents items de contrôle :

* [jump](#jump) saut vers un label de question (conditionnel ou inconditionnel)
* [set](#scoring) Fixer une étiquette de question (pour la notation et les nombres aléatoires)
* [random](#randomization) aléatoriser des questions
* [random jum](#randomjump) contrebalancer les versions d'un questionnaire
...
#### utiliser différentes sections de questionnaire pour différents participants [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#randomjump){#randomjump}
