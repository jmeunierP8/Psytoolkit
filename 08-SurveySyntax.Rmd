...
## Structure d'un questionnaire [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#_structure_of_questionnaire){#s8-1}
...
* Chaque questionnaire peut avoir des sections qui randomisent l'ordre ([en savoir plus sur l'ordre randomisé](#))
* Chaque questionnaire peut comporter des [commentaires](#) sur les lignes commençant par le signe hashtag (#)

### Structure générale d'une question [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#questionstructure){#s8-1-1}
...
### Commentaires pour les programmateurs [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#questionstructure){#s8-1-2}
...
### Formatage du texte [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#Comments){#s8-1-2}
...
### Types de questions [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#questiontypes){play}
Il y a les types de questions suivants :

* [radio](#radio) Un choix parmi de nombreuses options
* [check](#check) les choix multiples parmi les nombreuses options (cases à cocher)
* [experiment](#experiment) Intégrer une expérience
* [scale](#scale) Utiliser des échelles de type Likert
* [range](#range) Permet à l'utilisateur de saisir une plage de nombres entre deux valeurs
* [textline](#textiline) Le participant peut saisir seulement une ligne de texte
* [textbox](#textbox) Le participant peut saisir plusieurs lignes de texte
* [multiradio](#multiradio) Plusieurs éléments à choix unique dans une question

Il existe les types suivants qui ne présentent que des informations et un bouton "Continuer

* [info](#) Montrez juste quelques informations, un message, etc.
* [youtube](#) Montrer une vidéo YouTube

Il existe différents items de contrôle :

* [jump](#) saut vers un label de question (conditionnel ou inconditionnel)
* [set](#) Fixer une étiquette de question (pour la notation et les nombres aléatoires)
* [random](#) aléatoriser des questions

Vous pouvez insérer dans une question du son ou une vidéo : 

* [Play a sound](#playasound) Présenter un son dans une question
* [Play a video](#playavideo) Présenter une vidéo dans une question
* [youtube](#youtube) Jouer une vidéo youtube dans une question

#### Radio: Sélectionner un parmi plusieurs [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#radio){#radio}
...
- Ratatouille
````
![exemple de bouton radio](https://www.psytoolkit.org/doc3.1.0/question1.png)
...
![exemple avec autre réponse](https://www.psytoolkit.org/doc3.1.0/radio_other.png)

Parmi les questions fréquemment posées, il y a comment ajouter une option "autre" en utilisant une question séparée. [cliquez ici pour consulter la réponse](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#other).
...
#### check : sélectionner un ou plus parmi plusieurs [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#check){#check}
...
- Soup
````
![utilisation de check avec contrainte sur le nombre de réponse](https://www.psytoolkit.org/doc3.1.0/check.png)
...
#### rank: Classer ou ordonner les articles [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#rank){#rank}
...
#### Option non listée pour les question de type radio et check [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#others){#others}
...
#### info : Montrer une information, un message etc.[![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#info){#info}
...
#### Play a sound [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#sound){#playasound}
...
#### Play a video [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#video){#playavideo}
...
#### youtube [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#youtube){#youtube}
...
#### experiment : Intégrer une expérience de temps de réaction [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#experiment){#experiment}
...
#### jump : passer une question (conditionnelement ou non)[![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#jump){#jump}
...
- No
````
Enfin, dans les questions de type [check](#check), vous pouvez vérifier si un élément spécifique de votre liste a été coché Voici un exemple courant :
...
#### textline : saisie d'une ligne de texte [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#textline){#textline}
...
````
#### textbox : saisie d'une ou plusieurs ligne de texte [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.2.0/online-survey-syntax.html#textbox){#textbox}
...
#### Range : entrer une valeur numérique [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.2.0/online-survey-syntax.html#range){#range}
...
````
#### scale : échelles de type lickert [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.2.0/online-survey-syntax.html#scales){#scale}
...
#### multiradio : question à choix multiple [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#multiradio){#multiradio}
...
#### images [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#images){#images}
...
#### Changer le texte du bouton [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#buttontext){#buttontext}
...
- Potatoes
````
#### Aléatoriser l'ordre des questions [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#randomization){#randomization}
...
* Dans une section à ordre aléatoire, vous pouvez faire en sorte que certaines questions suivent toujours d'autres questions ([lire ici](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#link)).
...
- no
````
#### Calculer un score avec "set" [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#scoring){#scoring}
...
#### utiliser différentes sections section de questionnaire pour différents participants [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#randomjump){#randomjump}
...
- No
````
##### Contrebalancer des groupes [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#counterbalancing){#counterbalancing}
...
#### maxtime : questions temporisées [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#maxtime){#maxtime}
...
#### mintime : questions temporisées [![ukflag](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#mintime){#mintime}
