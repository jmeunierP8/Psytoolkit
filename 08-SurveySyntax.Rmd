...
## Structure d'un questionnaire [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#_structure_of_questionnaire){#s8-1}
...
### Structure générale d'une question [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#questionstructure){#s8-1-1}
...
### Commentaires pour les programmateurs [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#questionstructure){#s8-1-2}
...
### Formatage du texte [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#Comments){#s8-1-2}
...
### Types de questions [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#questiontypes){play}
...
#### Radio: Sélectionner un parmi plusieurs [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#radio){#radio}
...
#### check : sélectionner un ou plus parmi plusieurs [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#check){#check}
...
#### rank: Classer ou ordonner les articles [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#rank){#rank}
...
#### Option non listée pour les question de type radio et check [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#others){#others}
...
#### info : Montrer une information, un message etc.[![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#info){#info}
...
#### Play a sound [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#sound){#playasound}
...
#### Play a video [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#video){#playavideo}
...
#### youtube [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#youtube){#youtube}
...
#### experiment : Intégrer une expérience de temps de réaction [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#experiment){#experiment}
...
#### jump : passer une question (conditionnelement ou non)[![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#jump){#jump}
...
#### textline : saisie d'une ligne de texte [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#textline){#textline}
...
````
#### textbox : saisie d'une ou plusieurs ligne de texte [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.2.0/online-survey-syntax.html#textbox){#textbox}
...
#### Range : entrer une valeur numérique [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.2.0/online-survey-syntax.html#range){#range}
...
````
#### scale : échelles de type lickert [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.2.0/online-survey-syntax.html#scales){#scale}
...
#### multiradio : question à choix multiple [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#multiradio){#multiradio}
...
#### images [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#images){#images}
...
#### Changer le texte du bouton [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#buttontext){#buttontext}
...
- Potatoes
````
#### Aléatoriser l'ordre des questions [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#randomization){#randomization}
...
- no
````
#### Calculer un score avec "set" [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#scoring){#scoring}
...
#### utiliser différentes sections section de questionnaire pour différents participants [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#randomjump){#randomjump}
...
- No
````
##### Contrebalancer des groupes [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#counterbalancing){#counterbalancing}
...
#### maxtime : questions temporisées [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#maxtime){#maxtime}
...
#### mintime : questions temporisées [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.1.0/online-survey-syntax.html#mintime){#mintime}
