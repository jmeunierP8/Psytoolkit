...
### Radio: Sélectionner un parmi plusieurs [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/online-survey-syntax.html#radio){#radio}
...
### check : sélectionner un ou plus parmi plusieurs [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/online-survey-syntax.html#check){#check}
...
### rank: Classer ou ordonner les articles [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/online-survey-syntax.html#rank){#rank}
...
### Option non listée pour les question de type radio et check [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/online-survey-syntax.html#others){#others}
...
### info : Montrer une information, un message etc.[![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/online-survey-syntax.html#info){#info}
...
### Play a sound [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/online-survey-syntax.html#sound){#playasound}
...
### Play a video [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/online-survey-syntax.html#video){#playavideo}
...
### youtube [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/online-survey-syntax.html#youtube){#youtube}
...
### experiment : Intégrer une expérience de temps de réaction [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/online-survey-syntax.html#experiment){#experiment}
...
### jump : passer une question (conditionnelement ou non)[![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/online-survey-syntax.html#jump){#jump}
...
### textline : saisie d'une ligne de texte [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/online-survey-syntax.html#textline){#textline}
...
### multiradio : question à choix multiple [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/online-survey-syntax.html#multiradio){#multiradio}
...
### images [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/online-survey-syntax.html#images){#images}
...
### Changer le texte du bouton [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/online-survey-syntax.html#buttontext){#buttontext}
...
- Potatoes
````
### Aléatoriser l'ordre des questions [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/online-survey-syntax.html#randomization){#randomization}
...
- no
````
### Calculer un score avec "set" [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/online-survey-syntax.html#scoring){#scoring}
...
### utiliser différentes sections de questionnaire pour différents participants [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/online-survey-syntax.html#randomjump){#randomjump}
...
- No
````
### Contrebalancer des groupes [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/online-survey-syntax.html#counterbalancing){#counterbalancing}
...
## maxtime : questions temporisées [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/online-survey-syntax.html#maxtime){#maxtime}
...
## mintime : questions temporisées [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/online-survey-syntax.html#mintime){#mintime}
...
## Masquer / commenter les questions [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/online-survey-syntax.html#_hiding_commenting_questions_out){#hide}
...
## Stocker des données de manière anonyme tout en obtenant l'adresse électronique ou les données personnelles des personnes. [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/online-survey-syntax.html#_storing_data_anonymously_and_still_getting_peoples_email_or_personal_data){#personnaldata}
...
## Question multiple sur une page [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/online-survey-syntax.html#_multiple_question_on_one_page){#multiplequestionsonepage}
...
### Avantages d'une question par écran [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/online-survey-syntax.html#_advantages_of_one_question_per_screen){#advantageonequestion}
...
### Avantages de multiple questions par page
