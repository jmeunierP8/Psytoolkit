# Syntaxe pour  les scripts [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html){#syntax}
...
## Comment utiliser cette page de présentation des scripts d'expériences [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#_how_to_use_this_experiment_script_overview_page){#how_to_use_this_experiment_script_overview_page}
...
## Structure des scripts [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#_structure_of_scripts){#structure_of_scripts}
...
## Option de base [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options){#options}
...
### resolution [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options-resolution){#options-resolution}
...
### frame [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options-frame){#option-frame}
...
### scale [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options-scale){#options-scale}
...
### background color [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options-background){#options-backgroundcolor}
...
### fullscreen [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options-fullscreen){#options-fullscreen}
...
### mouse [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options-mouse){#options-mouse}
...
### set [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options-set){#options-set}
...
### start messages [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options-start-messages){#options-start-messages}
...
## Options avancées [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#advanced_options){#advanced_options}

### var in [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#_var_in){#var_in}
...
### var out [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#_var_out){#var_out}
...
### origin [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options-origin){#options-origin}
...
### fontdir,datadir,bitmapdir,sounddir [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options-sounddir){#options-sounddir}
...
## Options pour Linux [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options-sounddir){#options-sounddir}

### escape (C seulement) [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options-escape){#options-escape}
...
### parallelport (C seulement) [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options-parallelport){#options-parallelport}

Il s'agit d'un codage avancé du port parallèle.

### pcidio24 (C seulement) [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options-pcidio24){#options-pcidio24}

This is for advanced coding of the pcidio24 port

### cedrus (C seulement) [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options-cedrus){#options-cedrus}
...
### iolab (C seulement) [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options-iolab){#options-iolab}
...
### et (Linux seulement) [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options-et){#options-et}
...
### sprites first (Linux seulement) [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options-sprites-first){#options-sprites-first}
...
### executable [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options-executable){#options-executable}
...
### egi (C only) [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options-egi){#options-egi}
...
### vsync on|off [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options_vsync_off){#options_vsync_off}
...
### window (C only) [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options-window){#options-window}
...
### screensize and screendistance (C only) [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options-screendistance){#options-screendistance}
...
### version [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options-version){#options-version}
...
### check_refresh_rate [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#options-check-refresh-rate){#options-check-refresh-rate}
...
## Chargement des stimuli [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#loadingstimuli){#loadingstimuli}
...
### bitmaps [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#_bitmaps){#bitmaps}
...
### move [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#move){#move}
...
### relocate [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#relocate){#relocate}
...
### sounds [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#sounds){#sounds}
...
### sound frequencies[![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#sounds_as_frequencies){#sounds-frequencies}
...
### fonts [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#fonts){#fonts}
...
### videos [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#videos){#videos}
...
````
## Les tâches [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task){#task}
...
### Comment les tâches sont structurées [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#_how_tasks_are_structured){#how_tasks_are_structured}
...
### le concept de variables [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#variables-explained){#variables-explained}
...
### Le concept d'horodatage [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#timestamp){#timestamp}
...
### La fonction set [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-set){#task-set}
...
### définir une variable liste [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#set_array){#array-variable}

*Ces instruyctions sont destinés aux utilisateurs un peu plus expérimentés. Assurez-vous d'abord de comprendre les instructions relatives aux tableaux.
...
|-------------------|-----------------------------------------------------------|-----------------------|
| Instruction	      | Ce que cela fait	                                        | Exemple               |
|-------------------|-----------------------------------------------------------|-----------------------|
| set	              | définir une liste comme une suite de valeurs              |	set &&x 4 2 10 -1     |
| sort              | trier une suite de valeur	                                | set &&x sort          |
| range	            | Remplir une liste avec un intervalle                      | set &&x range 1 5     |
| shuffle	          | mélanger les valeurs d'une liste de façon aléatoire	      | set &&x shuffle       |
| remove	          | supprimer une valeur d'une liste                          | set &&x remove first  |
| sample	          | prendre n valeurs dans une liste de façon aléatoire       |	set &&x &&y sample 10 |
| uniq              |	supprimer toutes les valeurs apparaissant plus d'une fois	| set &&x uniq          |
| append            |	ajoute une valeur à la fin de la liste	                  | set &&x prepend 10    |
| clear	            | supprimer toutes les valeurs d'une liste	                | set &&xx clear        |
| *value* times *n* |	répéter une valeur (ou une liste) plusieurs fois         	| set &&x 10 times 5    |
|-------------------|-----------------------------------------------------------|-----------------------|
...
````
### définir une variable à partir d'une liste [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#set_from_array){#set_from_array}
...
|--------|------------------------------------------------------------------------------------------------------|
| code   | Ce que cela fait                                                                                     |
|---------------------------------------|-----------------------------------------------------------------------|
| locate | trouver la position d'une valeur dans la liste                                                       |
| remove | prendre et enlever d'une liste (first, last ou une position spécifique dans la liste)                |
| use    | utiliser mais pas enlever d'une liste (first, last, random ou  une position spécifique dans la liste)|
| size   | prendre un nombre d'items dans une liste                                                             |
| join   | mettre dans une varaible text la réunion d'éléments textuels d'une liste                             |
|--------|------------------------------------------------------------------------------------------------------|
...
### Synthèse de la fonction set [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#_summary_of_set){#summary_of_set}
...
## Instructions communément utilisées [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#_commonly_used_instructions){#commonly_used_instructions}
...
* [textbox](#textbox) permet d'entrer du texte, y compris des caractère spéciaux
...
* [set form array](#array-variable) paramétrer une variable à partir d'une valeur d'une liste

Chacune de ces instructions est détaillée ci-dessous.

### keys [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-keys){#task-keys}
...
### mouse on or off [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-mouse){#task-mouse}
...
### table [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#table){#task-table}
...
### show [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-show){#task-show}
...
* [une ligne de texte](#task-show-text)
...
### show bitmap [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-show-bitmap){#task-show-bitmap}
**syntaxe**
````
...
### show rectangle[![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-show-rectangle){#task-show-rectangle}
*syntaxe**
````
...
show rectangle 0 0 100 100 255 0 0
````
### show circle [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-show-circle){#task-show-circle}
...
### show background [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-show-background){#task-show-background}
...
### show text [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-show-text){#task-show-text}
...
### show video [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-show-video){#task-show-video}
...
````
   ...
   show video my_clip -100 100
````
### clear [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-clear){#task-clear}
...
### hide/unhide [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-hide){#task-hide}
...
### delay [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-delay){#task-delay}
...
### readkey [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-readkey){#task-readkey}
...
### keystatus [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-keystatus){#task-keystatus}
...
task checkKey
  ...
  while-end
````
### readkeys [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-readkeys){#task-readkeys}
...
### textbox [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-textbox){#textbox}
...
### readmouse [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-readmouse){#task-readmouse}
...
### drag [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-drag){#task-drag}
La fonction *drag* vous permet de faire glisser un stimulus d'un endroit à un autre. Il existe de nombreuses options pour ce faire. Souvent, il est plus facile de regarder d'abord un exemple simple. Le mieux est de lire la leçon sur [drag](https:/lessons/drag.html) pour des exemples détaillés.
...
Plus d'informations sur les variables liées à l'instruction [ici](#drag-variables).

### dragging [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-dragging){#task-dragging}
...
````
Plus d'informations sur les variables liées l'instruction *dragging* [ici](#drag-variables).

### variables utilisées avec drag et dragging [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#drag-variables){#drag-variables}
...
### progress [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-progress){#task-progress}
...
### choose [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-choose){#task-choose}
...
### rate [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-rate){#task-rate}
...
### save [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-save){#task-save}
...
### sound [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-sound){#task-sound}
...
### if [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-if){#task-if}
...
### while [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-while){#task-while}
...
## Instructions moins souvent utilisées {#s5-9} [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#_less_often_used_instructions){#less_often_used_instructions}

Certaines fonctions sont rarement utilisées ou nécessaires, mais elles ajoutent au potentiel des scripts du PsyToolkit.

### font [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#font){#font}
...
### end [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#task-end){#task-end}
...
### timestamp [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#_timestamp){#timestamp}
...
task MyTask
  ...
  save $x
````
### sprite [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#_sprite){#sprite}
...
## Instructions pour les équipements spéciaux [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#_instructions_for_special_equipment){#instructions_for_special_equipment}
...
## table [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#table){#table}
Les tables ont des lignes et des colonnes. Chaque fois qu'une table est utilisée dans une tâche, une de ses lignes est choisie. Chaque colonne peut être référencée en utilisant le signe @. Par exemple, @2 fait référence à la deuxième colonne de la ligne qui est choisie pour un essai de tâche donné. Dans le bloc, l'utilisateur peut spécifier comment les lignes du tableau sont sélectionnées. La sélection par défaut est aléatoire, mais il existe d'autres moyens (par exemple : ordre fixe, répétition sur un essai).
...
## block [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#block){#block}
...
### bitmap [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#block-bitmap){#block-bitmap}
...
### sound [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#block-sound){#block-sound}
...
### delay [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#block-delay){#block-delay}
...
### message [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#block-message){#block-message}
...
### pager [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#block-pager){#block-pager}
...
````
### Paramétrer les variables [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#block-set){#block-set}
...
### tasklist [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#block-tasklist){#block-tasklist}
...
#### maxtime [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#block-maxtime){#block-maxtime}
...
#### feedback [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#block-feedback){#block-feedback}
...
### blockorder [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#blockorder){#blockorder}
...
### include (usage avancé seulement) [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#include){#include}
...
### part (pour utilisateur avancé) [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#part){#part}
...
````
## Vue d'ensemble de toutes les variables du système [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#sysvars){#sysvars}
...
## Liens vers toutes les instructions [![](img/ukflag.png)](https://www.psytoolkit.org/doc3.4.0/syntax.html#overview){#syntax_overview}

(cette liste n'est pas encore complète)

Un court document sr la syntaxe est disponible [ici](https://www.psytoolkit.org/doc3.4.0/short_syntax.html) (en anglais)
...
* [Instructions moins souvent utilisées](#less_often_used_instructions) : [readmouse](#task-readmouse) | [if](#task-if) | [while](#task-while) | [move](#task-move) | [relocate](#task-relocate) | [hide](#task-hide) | [unhide](task-unhide) | [font](#task-font) [drag](#task_drag) | [dragging](#task_dragging)
